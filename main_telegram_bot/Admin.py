...
db = Database('/home/str/4blag/cfg/database')
...
async def add_bot_start(message: Message):
    ...
    if str(message.from_user.id) in str(ADMIN_ID):
        ...
        media = MediaGroup()
        media.attach_photo(InputFile('img/0000.jpg'), 'Вид бота 1')
        media.attach_photo(InputFile('img/000.jpg'), 'Вид бота 2')
        media.attach_photo(InputFile('img/00.jpg'), 'Вид бота 3')
        media.attach_photo(InputFile('img/0.jpg'), 'Вид бота 4')
